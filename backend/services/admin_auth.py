...
from utils.helpers import hash_password, verify_password, create_access_token, create_refresh_token, decode_token
...
class AdminAuthService:
    ...
    async def authenticate(email: str, password: str, ip_address: str) -> dict:
        ...
        refresh_token = create_refresh_token(str(admin["_id"]), admin.get("role", "admin"))
